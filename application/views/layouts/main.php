...
<head>
    ...
    <meta name="google-site-verification" content="uBiIaEGjnz8jgnbVjbyBv1morX9dbJkoBQECUQ0Av-s" />
    <meta name="description" content="website outbound membahas segala hal mengenai outbound, jasa pelatihan outbound.">
    <meta name="keywords" content="outbound,outbound puncak,outbound bogor,outbound training, outbounditu.com, www.outbounditu.com">
	  ...
	  <!-- CSS Customization -->
        ...
        <script>
          (adsbygoogle = window.adsbygoogle || []).push({
            google_ad_client: "ca-pub-4624145575375361",
...
<body>
	<main>
		...
		<header id="js-header" class="u-header u-header--sticky-top u-header--toggle-section u-header--change-appearance" data-header-fix-moment="500">
		    ...
		    <section class="g-pt-80 g-bg-red" >
		    	<h4 class="g-font-weight-700 g-color-white g-font-size-18  text-uppercase text-center">
	              Nusantara.net.id
